...
import {HomeStackScreen,MonitorStackScreen,RoomLayoutStackScreen,ManageStackScreen,PredictionStackScreen,SettingsStackScreen} from './DrawerComponents'
                ...
                <View style={styles.drawerContent}>
                    ...
                    <Drawer.Section style={styles.drawerSection}>
                        <DrawerItem 
                            ...
                            label="Home"
                            onPress={() => {props.navigation.navigate('HomeSec')}}
                        />
                        <DrawerItem 
                            icon={({color, size}) => (
                                <Icon 
                            ...
                            label="Monitor"
                            onPress={() => {props.navigation.navigate('Monitor')}}
                        />
                        <DrawerItem 
                            icon={({color, size}) => (
                                <Icon 
                            ...
                            label="Room Layout"
                            onPress={() => {props.navigation.navigate('RoomLayout')}}
                        />
                        <DrawerItem 
                            icon={({color, size}) => (
                                <Icon 
                        ...
                        <TouchableRipple onPress={() => {toggleTheme()}}>
                            <View style={styles.preference}>
                                ...
                                <View pointerEvents="none">
                                    <Switch value={isDarkTheme} color='#068527'/>
                                </View>
                            </View>
                        </TouchableRipple>
                    </Drawer.Section>
